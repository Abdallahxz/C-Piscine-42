...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/19 16:33:48 by aassaad-          #+#    #+#             */
/*   Updated: 2024/03/19 16:41:25 by aassaad-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    char **split_strings = ft_split(str, charset);
    ...
    if (split_strings) {
        ...
        // Free the memory allocated for the split strings array
